...
with ClientAsync() as client:
    with aw(client.lock()) as node:
        ...
        shortest_list, polys_list_resized_merged, incenters_list = global_navigation(polys_list, 1.25*robot_width , robot_pos_pix, goal_pos_pix)
